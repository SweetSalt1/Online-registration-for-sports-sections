...
public:
    ...
    static std::string PackRegister(const std::string& login, const std::string& password, const std::string& full_name);
    ...
    static std::string PackModeration(const std::string& token, int application_id, bool approve);
